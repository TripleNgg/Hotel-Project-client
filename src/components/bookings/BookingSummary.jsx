...
BookingSummary.propTypes = {
    booking: PropTypes.shape({
        checkInDate: PropTypes.string.isRequired, // Update this based on the actual type
        ...
        // Add other PropTypes for the properties inside the booking object
        // For example: numOfAdults, numOfChildren, etc.
    }).isRequired,
